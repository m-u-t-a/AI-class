...
from classificator.classificator import predict
from extractor.extractor import extract_text_from_pdf, extract_promts, extract_full_appeal, extract_fields
...
<div style='font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto;'>
    ...
    <table style='width: 100%; border-collapse: collapse; margin-bottom: 20px;'>
        ...
        <tr>
            <td style='padding: 8px; border: 1px solid #ddd;'><strong>Населённый пункт</strong></td>
            <td style='padding: 8px; border: 1px solid #ddd;'>{data['населённый_пункт']}</td>
        </tr>
        <tr>
    ...
    <div style='background-color: #f8f9fa; padding: 15px; border-left: 4px solid #4e73df; margin-bottom: 20px;'>
        ...
        <p style='white-space: pre-line;'>{predict(data['текст_обращения'])}</p>
    </div>
</div>
"""
